...
///////////////////FileChannelBase///////////////////
    ...
    FileChannelBase::FileChannelBase(const string &name, const string &path, LogLevel level) : LogChannel(name, level),
                                                                                               _path(path) {}
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void LoggerWrapper::printLogV(Logger &logger, int level, const char *file, const char *function, int line,
    ...
    void LoggerWrapper::printLog(Logger &logger, int level, const char *file, const char *function, int line,
                                 const char *fmt, ...) {
        va_list ap;
        va_start(ap, fmt);
